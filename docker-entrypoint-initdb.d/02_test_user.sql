...
('チャーハン', 'パラパラに仕上がる本格チャーハン', 15, 2, 4, NULL, 4),
('カレーライス', 'スパイスから作る本格カレー', 60, 6, 2, NULL, 5),
('パスタ・カルボナーラ', '生クリーム不使用の本格カルボナーラ', 20, 2, 1, 'https://recipe-blog.jp/sample3', 4);
...
('麻婆豆腐', '本格四川風の辛い麻婆豆腐', 25, 4, 2, '中華料理入門', 78, 4);
-- ============================================
-- 3. 材料データ投入
-- ============================================
-- 鶏の唐揚げ（recipe_id: 1）
...
(6, '2025-06-08', 5, 45, 5, '母の味を再現できた。じゃがいもが煮崩れしないコツを掴んだ', 3, 500.00, '夕食');
-- ============================================
-- 8. サンプル写真データ
-- ============================================
...
(4, 'https://example.com/images/mapo-tofu-ref.jpg', 1, TRUE, 1, '麻婆豆腐の参考写真'),
(4, '/uploads/my-mapo-tofu-2024-12-04.jpg', 3, FALSE, 2, '実際に作った麻婆豆腐'),
(5, '/uploads/my-chocolate-cake-2024-12-05.jpg', 3, FALSE, 1, '実際に作ったチョコレートケーキ');
